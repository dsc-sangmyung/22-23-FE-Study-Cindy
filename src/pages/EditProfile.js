    ...
    return (
        <div className='main_page'>
            ...
            <div className='content_area'>
                <div className='edit_content_area'>
                    <ul className='edit_content_left'>
                        <div className='metatag'>
                            <svg aria-label="Facebook 로고 마크 및 앱 패밀리 로고" height="12" role="img" viewBox="0 0 500 100"
                                 width="60">
                                <defs>
                            ...
                            <div className='fs-4 fw-6 mt-4'>계정 설정의 위치가 일부 변경됩니다</div>
                            <div className='mt-4'>곧 계정 센터가 회원님의 계정 정보와 설정을 관리하는 기본 위치가 됩니다.</div>
                            <div className='mt-3 bold'><a target='_blank' href='https://www.meta.com/ko-kr/help/accounts-center/accounts-center-settings/'>더 알아보기</a></div>
                        </div>
                    </ul>
                    <article>
                        <div className='edit_profile'>
                            <img src={require('../assets/img/profile2.jpg')} className='profile_edit_image'></img>
                        </div>
                    </article>
                </div>
            </div>
