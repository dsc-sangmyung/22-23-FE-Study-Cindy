        ...
        <div id='sidebar'>
          ...
          <div className='sidebar-menu'>
            <div className='SideHome'>
              <li>
                <svg aria-label="홈" className="_ab6-" color="#262626" fill="#262626" height="24" role="img"
                ...
                <span className='side_text'>홈</span>
              </li>
            </div>
            <div className='SideHome'>
              <li>
                <svg aria-label="검색" className="_ab6-" color="#262626" fill="#262626" height="24" role="img"
                     viewBox="0 0 24 24" width="24">
                ...
                <span className='side_text'>검색</span>
              </li>
            </div>
            <div className='SideHome'>
              <li>
                <svg aria-label="탐색 탭" className="_ab6-" color="#262626" fill="#262626" height="24" role="img"
                     viewBox="0 0 24 24" width="24">
                ...
                <span className='side_text'>탐색 탭</span>
              </li>
            </div>
            <div className='SideHome'>
              <li>
                <svg aria-label="Messenger" className="_ab6-" color="#262626" fill="#262626" height="24" role="img"
                     viewBox="0 0 24 24" width="24">
                  <path
                ...
                <span className='side_text'>메시지</span>
              </li>
            </div>
            <div className='SideHome'>
              <li>
                <svg aria-label="알림" className="_ab6-" color="#262626" fill="#262626" height="24" role="img"
                     viewBox="0 0 24 24" width="24">
                  <path
                ...
                <span className='side_text'>알림</span>
              </li>
            </div>
            <div className='SideHome'>
              <li>
                <svg aria-label="새로운 게시물" className="_ab6-" color="#262626" fill="#262626" height="24" role="img"
                     viewBox="0 0 24 24" width="24">
                  <path
                ...
                <span className='side_text'>만들기</span>
              </li>
            </div>
            <div className='SideHome'>
              <img src={require('../assets/img/profile2.jpg')} className='profile_image'></img>
              <span className='side_text'>프로필</span>
            </div>
          </div>
          {/*under menu bar*/}
          <div className='SideHome'>
            <li>
              <svg aria-label="설정" className="_ab6-" color="#262626" fill="#262626" height="24" role="img"
                   viewBox="0 0 24 24" width="24">
                <line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              ...
              <span className='side_text'>더보기</span>
            </li>
          </div>
        </div>
