...
function SideBar(){
    return(
        <div id='sidebar'>
          <svg aria-label="Instagram" className="_ab6- instagram_logo" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height="29"
          ...
          <div className='sidebar-menu'>
            ...
            <div className='SideHome'>
              <li>
                <svg aria-label="릴스" className="_ab6-" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height="24" role="img"
                     viewBox="0 0 24 24" width="24">
                ...
                <span className='side_text'>릴스</span>
              </li>
            </div>
            <div className='SideHome'>
              <li>
